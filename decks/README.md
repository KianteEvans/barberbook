...
case (3–5), the opportunity sized against the base (6–7), the five motions with the attach
run as presales insertion plus base sequencing (8–14), how the money moves through CPPO
(15), and proof, activation, the honest caveats, and a forwardable one-frame summary
(16–20). Every slide carries speaker notes;
...
1. **Slide 16 uses figures from Archera's customer reference pack, which is marked
...
3. **Slide 9's presales stages follow Automatum's published motion** — swap in the real
   internal stage names. The commercial terms on slides 6, 14 and 15 now come from
...
(defined on slide 2), and states on slide 18 that the guarantees are contractual and
