...
# ---------- shared content ----------
COMMON_TECH_TAIL = ("No component is used that is not listed here. Licence cost recovery sits inside the engagement fee.")
...
SOLUTIONS = [
{
 ...
 "overview":{
  ...
  "Organization/ Teaming Structure":[
   ...
   "The delivery window is a staffing commitment and is to be capacity-tested before publication. [Concurrent engagement capacity — to confirm.]",
...
},
{
 ...
 "overview":{
  "Executive summary":[
   ...
   "The solution pairs with the Marketplace Compliance Accelerator, which produces the listing the partnership is built around. Both are proposed for wave one.",
  ],
  "Description of Solution":[
   ...
   "The BOX Program listings referenced above are the ISV customer's own participation, which this retainer drives them toward. They are separate from the four Automatum × OBP solutions and their milestones. The figures coincide because both run the same AWS programme schedule.",
  ],
  "Technology considerations":[
   ...
   "No third-party component is licensed into this solution. " + COMMON_TECH_TAIL,
  ],
  "Market Fit":[
   ...
   "Demand: driven by the gap between what AWS programmes offer an ISV and what an unstaffed ISV captures. Most ISVs qualify for programme benefits they never apply for.",
   "Competitors: a direct Director of Alliances hire, AWS consulting partners offering alliance advisory, and doing nothing. The differentiator is a named owner at a stated cadence with a filed application trail.",
  ],
  "Marketing strategy":[
   "The solution carries its own overview and deck, and lists under its own Solution ID.",
  ...
  "Organization/ Teaming Structure":[
   ...
   "Named-owner hours per rung, whether a backup is funded at the bottom rung, and how many accounts one owner can hold are to be capacity-tested against the full additive load at the top rung before any figure is published. [Staffing model — to confirm.]",
  ...
  "Findings and recommendations":[
   ...
   "Findings: a line-of-business buyer and a top-line outcome, with a commercial model sound at list price. The open risk is delivery capacity rather than demand — every commitment here is a staffing commitment, and none should be published before the capacity model is tested.",
...
SOLUTIONS += [
{
 ...
 "overview":{
  ...
  "Description of Solution":[
   ...
   "This solution includes the listing work the Marketplace Compliance Accelerator also delivers. See Findings and recommendations for how the two are positioned.",
  ],
  "Technology considerations":[
   "Delivery is professional services against AWS-operated systems; there is no new software to build.",
  ...
  "Organization/ Teaming Structure":[
   ...
   "Every turnaround here is a staffing commitment and is to be capacity-tested before publication. [Desk coverage window and time zone, and accounts per owner — to confirm.]",
   "Hiring is anticipated at [volume threshold — to model].",
  ],
  "Schedule":[
...
},
{
 ...
 "overview":{
  ...
  "Market Fit":[
   ...
   "Competitors: a channel manager hire plus a PRM subscription, channel consultancies, and doing nothing. The differentiator is a committed roster under management, a stated deal-desk turnaround, and a reported number held in a system of record.",
  ],
  "Marketing strategy":[
   "The solution carries its own overview and deck, and lists under its own Solution ID.",
  ...
  "Organization/ Teaming Structure":[
   ...
   "The deal-desk turnarounds and the review cadence are staffing commitments and are to be capacity-tested before publication, including the uncapped roster at the top rung. [Named-owner hours per rung and accounts per owner — to confirm.]",
   "Hiring is anticipated at [volume threshold — to model].",
  ],
  "Schedule":[
